...
influxdb_url = "http://10.101.10.48:8086/api/v2/write"  # IP where DB lives
org = "pqreact"
bucket = "NUC2_metrics"  # a bucket to send metrics
token = "tlLqe3CyAFG_gTHgM0gju_cnSon95j99oveOjwyWTO3udC0gdamxAFgCQUsx2ebbTpg2WfktMSNjWm7TRP3Owg=="
