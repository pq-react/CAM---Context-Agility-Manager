...
# VM (.247) so testing can begin.
#
# What this script does:
#
#   1. rsync the entire CAM clone to /home/localadmin/cam/ on the target VM.
...
#
# Env (defaults shown):
#   QUJATA_VM   10.160.101.247   target VM (also runs the MCP server stack)
#   SSHPASS     ii70mseq
#   SSHUSER     localadmin
#   REMOTE_DIR  /home/localadmin/cam
#
# Usage:
...
QUJATA_VM="${QUJATA_VM:-10.160.101.247}"
SSHPASS_VAL="${SSHPASS:-ii70mseq}"
SSHUSER="${SSHUSER:-localadmin}"
REMOTE_DIR="${REMOTE_DIR:-/home/localadmin/cam}"
